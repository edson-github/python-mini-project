...
print(
    ...
    random.choice(noun),
    f" in the fries,causing him to have a {body_part} ache.",
)
print("In response, he threw up all over his " , random.choice(plural) , ".")
print(
    f"In his report, the inspector {adverb} recommended that the school cafeteria serve only nutritious ",
    random.choice(plural),
...
print(f"He rated the cafeteria a {letter}-minus.")
